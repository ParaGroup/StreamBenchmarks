...
public class SpikeDetection {
    ...
    public static void main(String[] args) {
        if (args.length == 1 && args[0].equals(BaseConstants.HELP)) {
            String alert = "Parameters: --rate <value> --sampling <value> --parallelism <nSource nMoving-Average nSpike-Detector nSink>\n";
            LOG.error(alert);
        }
        else {
            // load configuration
