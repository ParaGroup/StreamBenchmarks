...
public class Log {
    static {
        ...
        Configurator.setLevel("TrafficMonitoring", level);
        // restrict messages from other components
        level = Level.toLevel(System.getenv("ROOT_LOG_LEVEL"), Level.ERROR); // insted of Level.ERROR only for this application
