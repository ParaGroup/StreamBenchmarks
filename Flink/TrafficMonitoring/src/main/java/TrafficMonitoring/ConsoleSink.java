 ...
 *  roadID.
 */ 
public class ConsoleSink extends RichSinkFunction<Speed_Event> {
    ...
    // invoke method
    @Override
    public void invoke(Speed_Event input, Context context) throws Exception {
        int roadID = input.roadID;
        int avg_speed = input.avg_speed;
