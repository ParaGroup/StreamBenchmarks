...
public class RoadGridList {
    private HashMap<String, RoadList> gridList = new HashMap<>();//hashmap to store all states.
    ...
    private HashMap<String, RoadList> read(String path) throws IOException, SQLException {
        File file = new File(System.getProperty("user.home").concat("/StreamBenchmarks/Datasets/").concat(path));
