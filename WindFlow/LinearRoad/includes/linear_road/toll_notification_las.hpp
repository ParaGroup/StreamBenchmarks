...
#include<linear_road/lav_tuple.hpp>
...
class TollNotificationLas
{
public:

    void operator ()(const LavTuple &tuple, wf::Shipper<NotificationTuple> &shipper, wf::RuntimeContext &rc);
